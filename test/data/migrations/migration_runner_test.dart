...
void main() {
  group('MigrationRunner', () {
    test('returns json unchanged when current version already matches target', () {
    ...
    test('applies multiple migrations sequentially v1 -> v2 -> v3', () {
      ...
      final runner = MigrationRunner(targetVersion: 3, migrations: [m1to2, m2to3]);
    ...
    test('applies migrations in chain regardless of registration order', () {
      ...
      final runner = MigrationRunner(targetVersion: 3, migrations: [m2to3, m1to2]);
    ...
    test('throws when data version exceeds target (downgrade not supported)', () {
      final runner = MigrationRunner(targetVersion: 1, migrations: const []);
